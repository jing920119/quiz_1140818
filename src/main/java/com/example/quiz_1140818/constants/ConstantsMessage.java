...
public class ConstantsMessage {
	...
	public static final String PARM_ACCOUNT_ERROR="Param account error!";
	...
	public static final String QUESTION_OPTION_ERROR="Question option error!";
	public static final String QUESTION_TYPE_ERROR="Question type error!";
	public static final String QUESTION_OPTIONS_CODE_ERROR="Question type error!";
	public static final String QUESTION_OPTIONS_NAME_ERROR="Question type error!";
	public static final String QUESTION_ID_LIST_IS_EMPTY="Question id list is empty!";
